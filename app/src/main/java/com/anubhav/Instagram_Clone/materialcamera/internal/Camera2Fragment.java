...
//      releaseRecorder();
   ...
   * @link
   *     https://github.anubhav/googlesamples/android-Camera2Basic/blob/master/Application/src/main/java/anubhav/example/android/camera2basic/Camera2BasicFragment.java
   */
