...
import com.anubhav.Instagram_Clone.materialcamera.util.Degrees;
import com.anubhav.Instagram_Clone.materialcamera.util.ImageUtil;
import com.anubhav.Instagram_Clone.materialcamera.util.ManufacturerUtil;

import static com.anubhav.Instagram_Clone.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_BACK;
import static com.anubhav.Instagram_Clone.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_FRONT;
import static com.anubhav.Instagram_Clone.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_UNKNOWN;
import static com.anubhav.Instagram_Clone.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_ALWAYS_ON;
import static com.anubhav.Instagram_Clone.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_AUTO;
import static com.anubhav.Instagram_Clone.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_OFF;
...
public class CameraFragment extends BaseCameraFragment implements View.OnClickListener {
  ...
  com.anubhav.Instagram_Clone.materialcamera.internal.CameraPreview mPreviewView;
...
//      Log.d(TAG, "openCamera: height: " + height);
  ...
  private void createPreview() {
    ...
    if (mWindowSize == null) mWindowSize = new Point();
    activity.getWindowManager().getDefaultDisplay().getSize(mWindowSize);
    mPreviewView = new com.anubhav.Instagram_Clone.materialcamera.internal.CameraPreview(getActivity(), mCamera);
    if (mPreviewFrame.getChildCount() > 0 && mPreviewFrame.getChildAt(0) instanceof com.anubhav.Instagram_Clone.materialcamera.internal.CameraPreview)
